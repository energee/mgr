/**
 * Yeast Pitch Entity — presentation
 *
 * The React/UI half of the yeast pitch entity: list columns, list filters,
 * and the unified detail/edit sections.
 */

import type { EntityPresentation } from "@/types/entity";
import { StatusBadge } from "@/components/universal/status-badge";
import type { YeastPitch } from "./core";
import {
  SOURCE_TYPE_OPTIONS,
  STATUS_DISPLAY,
  VIABILITY_STATUS_DISPLAY,
  statusOptions,
} from "./core";

export const yeastPitchPresentation: EntityPresentation<YeastPitch> = {
  // ---------------------------------------------------------------------------
  // List View
  // ---------------------------------------------------------------------------
  listColumns: [
