...
const settingsLinks = [
  {
    ...
    description: "Configure brewery name, contact info, and business defaults",
  ...
  {
    title: "Locations",
    description: "Manage facilities, warehouses, and taproom locations",
  ...
  {
    title: "Users",
    description: "View team members and manage access",
    href: "/settings/users",
    icon: Users,
    available: true,
  },
