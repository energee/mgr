...
// =============================================================================
// batchRecordInvalidationKeys (issue #560)
// =============================================================================
...
describe("batchRecordInvalidationKeys", () => {
  it("covers every cache the batch record lives in, including the unified detail's view key", async () => {
    ...
    const id = "abc-123";
    // The unified batch detail page caches the record under the
    // batches_with_brew_info view key (detailQueryOptions + viewTable) —
    // invalidating batchKeys.detail alone left the status badge stale (#560).
