...
export type { IconHandle as HardDriveUploadIconHandle } from "@/components/icons/create-animated-icon";
...
const HardDriveUploadIcon = createAnimatedIcon({
  displayName: "HardDriveUploadIcon",
