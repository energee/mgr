...
export type { IconHandle as TelescopeIconHandle } from "@/components/icons/create-animated-icon";
...
const TelescopeIcon = createAnimatedIcon({
  displayName: "TelescopeIcon",
