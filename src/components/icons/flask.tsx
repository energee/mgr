...
// Animated flask icon built on the shared scaffold in create-animated-icon.tsx
...
export type { IconHandle as FlaskIconHandle } from "@/components/icons/create-animated-icon";

const FlaskIcon = createAnimatedIcon({
  displayName: "FlaskIcon",
