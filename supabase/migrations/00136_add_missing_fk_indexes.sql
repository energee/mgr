-- NOTE (PR #322): byte-identical rebase duplicate of 00129_add_missing_fk_indexes.sql
-- (same artifact class as the documented 00130/00137 pair). Retained because it
-- may be recorded as applied; every statement is idempotent. Fixed identically.
--
