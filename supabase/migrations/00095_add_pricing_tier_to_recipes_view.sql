-- Add pricing_tier_id to recipes_with_estimates view.
-- This column was added to the recipes table but missed in the view,
-- causing the recipe detail page to not load or save pricing tier values.
