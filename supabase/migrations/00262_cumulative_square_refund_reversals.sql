-- Fix sequential partial Square refunds under-crediting finished-goods bins.
--
-- 00257 sized every refund independently and floored each event's share of
-- the original sale allocation. For a three-unit sale, two 50% refunds
